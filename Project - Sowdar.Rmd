---
title: "Project - testing this change"
author: "Team"
...
With the advent of new technology and techniques in data science, the classification of the substrates, which was an ardent manual task before can now be fully automated. This project would endevour to identify new substrates within the 12,000 insulin phosphorylation sites that are provided.

The report below would will explain in detail the stages of the project, the analysis performed in each stage and final model predictions with the output of at each stage.

#Data
Dataset provided for the this analysis consists of the following 3 data sets
...
##Reading the Insulin Phosphorylation raw data from the txt file
